...
def isValidWord(word, hand, wordList):
    ...
    # Using getFrequencyDict function
    word_frequency_dict = getFrequencyDict(word)
    for k in word_frequency_dict:
        if k not in hand: # 这里是否多余了？
            return False
        elif word_frequency_dict[k] > hand[k]:
            return False
...
#==============================================================================
#     temp_dict = {'h': 2, 'e': 1, 'l': 2, 'o': 2, 'i': 1, 'g': 1}    
#     playHand(temp_dict, wordList, 7)
#==============================================================================
...
#    playHand({'n':1, 'e':1, 't':1, 'a':1, 'r':1, 'i':2}, wordList, 7)
    ...
    while True:
        ...
        if user_input == 'n':
            current_playing_hand = dealHand(HAND_SIZE)
            playHand(current_playing_hand, wordList, HAND_SIZE)
        elif user_input == 'r':
            if len(current_playing_hand) == 0:
